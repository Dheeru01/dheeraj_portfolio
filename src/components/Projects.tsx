            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {featuredProjects.map((project, index) => (
                <div
                  ...
                  style={{ animationDelay: `${index * 0.2}s`, minHeight: '500px' }}
                >
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    <h3 className="text-2xl font-bold mb-3 text-black group-hover:text-gray-800 transition-colors duration-300 line-clamp-2" style={{ minHeight: '3.5rem' }}>{project.title}</h3>
                    <p className="text-gray-700 mb-4 leading-relaxed flex-grow line-clamp-3" style={{ minHeight: '4.5rem' }}>{project.description}</p>
                    <div className="flex flex-wrap gap-2 mt-auto" style={{ minHeight: '2.5rem' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherProjects.map((project, index) => (
              <div
                ...
                style={{ animationDelay: `${(featuredProjects.length + index) * 0.1}s`, minHeight: '400px' }}
              >
                <div className="relative overflow-hidden">
                  <img
                    src={project.image || "https://images.unsplash.com/photo-1518770660439-4636190af475?w=500&h=300&fit=crop"}
                ...
                <div className="p-4 flex-grow flex flex-col">
                  <h3 className="text-xl font-bold mb-2 text-black line-clamp-2" style={{ minHeight: '3rem' }}>{project.title}</h3>
                  <p className="text-gray-700 text-sm mb-3 leading-relaxed flex-grow line-clamp-3" style={{ minHeight: '3.5rem' }}>{project.description}</p>
                  <div className="flex flex-wrap gap-1 mb-3" style={{ minHeight: '2rem' }}>
                    {project.tech.split(', ').map((tech, techIndex) => (
                      <span
                        key={techIndex}
